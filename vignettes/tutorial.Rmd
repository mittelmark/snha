...
a correlation plot and then a plot of the graph overlaying the edges with these
values.

```{r label=corrplot,fig.width=10,fig.height=5,fig.cap="Correlation and Network plot with correlation values"}
...
rarely are less likely to be of importance.
